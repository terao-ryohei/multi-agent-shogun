...
- Run the same checks as GitHub Actions _before_ committing.
...
**Key insight**: Kimi's Agent Swarm is complementary, not competing. It could run _inside_ a single ashigaru's tmux pane, providing sub-delegation within that agent.
